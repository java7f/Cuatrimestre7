...
// Función que retorna el número de iteraciones que toma hacer el cálculo del pixel.
    ...
    if(myRank > 0)
    {
        ...
        for(int i = startingStrip; i < endStrip; i++)
        {
            ...
            for(int j = 0; j<WIDTH; j++)
            {
                ...
                int n = calcMandelbrot(complexR, complexI, ITERATIONS);
...
void mandelbrotPPM()
{
    ...
    //Impresión de la matriz resultante en el archivo luego de calcular el color del pixel.
